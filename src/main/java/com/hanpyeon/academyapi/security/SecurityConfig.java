...
//                                    Role.STUDENT.getSecurityRole());
                    ...
                    request.requestMatchers("/api/manage/courses/**")
                            .hasAnyAuthority(
                                    Role.MANAGER.getSecurityRole(),
                                    Role.TEACHER.getSecurityRole());
// 시험지 반 관리 API                    request.requestMatchers(HttpMethod.POST, "/api/manage/test-papers")                            .hasAnyAuthority(                                    Role.MANAGER.getSecurityRole(),                                    Role.TEACHER.getSecurityRole(),                                    Role.ADMIN.getSecurityRole());                    request.requestMatchers(HttpMethod.PUT, "/api/manage/test-papers/**")                            .hasAnyAuthority(                                    Role.MANAGER.getSecurityRole(),                                    Role.TEACHER.getSecurityRole(),                                    Role.ADMIN.getSecurityRole());                    request.requestMatchers(HttpMethod.DELETE, "/api/manage/test-papers/*")                            .hasAnyAuthority(                                    Role.MANAGER.getSecurityRole(),                                    Role.TEACHER.getSecurityRole(),                                    Role.ADMIN.getSecurityRole());                    request.requestMatchers(HttpMethod.GET, "/api/test-papers")                            .authenticated();                    request.requestMatchers(HttpMethod.GET, "/api/test-papers/**")                            .authenticated();
                    ...
                    request.requestMatchers(HttpMethod.POST, "/api/directories")
                            .hasAnyAuthority(
                                    Role.ADMIN.getSecurityRole(),
// 문제집 강의 API                    request.requestMatchers(HttpMethod.POST, "/api/test-papers/*/lecture")                            .hasAnyAuthority(                                    Role.MANAGER.getSecurityRole(),                                    Role.TEACHER.getSecurityRole(),                                    Role.ADMIN.getSecurityRole());                    request.requestMatchers(HttpMethod.PUT, "/api/test-papers/lectures/*")                            .hasAnyAuthority(                                    Role.MANAGER.getSecurityRole(),                                    Role.TEACHER.getSecurityRole(),                                    Role.ADMIN.getSecurityRole());                    request.requestMatchers(HttpMethod.DELETE, "/api/test-papers/lectures/*")                            .hasAnyAuthority(                                    Role.MANAGER.getSecurityRole(),                                    Role.TEACHER.getSecurityRole(),                                    Role.ADMIN.getSecurityRole());                    request.requestMatchers(HttpMethod.GET, "/api/test-papers/*/lecture")                            .authenticated();                    request.requestMatchers(HttpMethod.GET, "/api/test-papers/lectures/*")                            .authenticated();
                                    Role.MANAGER.getSecurityRole(),
                                    Role.TEACHER.getSecurityRole()
                            );
